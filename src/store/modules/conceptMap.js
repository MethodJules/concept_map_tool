        ...
        */
        ...
        async loadConceptMapFromBackend({commit}) {
            ...
            .then((response) => {  
                ...
                // Bad solution: We can take all the concept maps and search in them, which will take too much time.
                // let conceptMapIds = rootState.drupal_api.user.concept_map_id;
                // let userConceptMaps = [];
                // conceptMapIds.forEach((conceptMapId)=>{
                //     data.forEach((conceptMap)=>{
                //         if(conceptMap.id==conceptMapId){
                //             userConceptMaps.push(conceptMap)
                //         }
                //     })
                // })
                // console.log(userConceptMaps)
            }).catch(error => {
